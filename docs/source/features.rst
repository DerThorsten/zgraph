...
============
    ...
    * Continous Integration:
        * `azure-pipelines <https://dev.azure.com/DerThorsten/zgraph/_build/latest?definitionId=1&branchName=master>`_
        * `circle-ci <https://circleci.com/gh/DerThorsten/zgraph/tree/master>`_
        * `travis-ci <https://travis-ci.org/DerThorsten/zgraph>`_
    * bumpversion for version handling
    * Documentation with sphinx breathe and on
      `readthedocs <http://zgraph.readthedocs.io/en/latest/?badge=latest>`_
